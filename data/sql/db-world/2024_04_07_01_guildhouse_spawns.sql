...
REPLACE INTO `guild_house_spawns` (`id`, `entry`, `posX`, `posY`, `posZ`, `orientation`, `comment`) VALUES
  ...
  (30, 8719, 16243.7, 16291.3, 22.9312, 1.52061, 'Alliance Auctioneer'),
  (31, 9856, 16240.5, 16291.6, 22.9312, 1.52061, 'Horde Auctioneer'),
  ...
  (35, 500000, 16217.2, 16263.0, 13.55747, 3.028813, 'Portal: Stormwind (Object)'),
  (36, 500001, 16219.9, 16259.8, 13.29972, 3.028813, 'Portal: Darnassus (Object)'),
  (37, 500002, 16219.3, 16256.9, 13.19947, 3.028813, 'Portal: Exodar (Object)'),
  (38, 500003, 16218.3, 16253.7, 12.98520, 3.028813, 'Portal: Ironforge (Object)'),
  ...
  (48, 2832, 16230.2, 16316.1, 20.8455, 4.64365, 'Food & Drink Vendor'),
  ...
  (54, 9858, 16237.10, 16291.9, 22.9299, 1.55386, 'Neutral Auctioneer'),
  (55, 2622, 16242.8, 16302.1, 13.176, 4.55570, 'Shady Dealer');
